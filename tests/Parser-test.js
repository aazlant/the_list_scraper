...
describe('Parser', ()=> {
    ...
    const scrapedContent = JSON.parse(fs.readFileSync(path.resolve(__dirname, './fixtures/scraped_sample.json')));
    const expectedContent = JSON.parse(fs.readFileSync(path.resolve(__dirname, './fixtures/parsed_sample.json')));
